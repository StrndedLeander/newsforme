    ...
    'SessionEndedRequest': function () {
     ...
     'nextArticle': function () {
        ...
        // Session Index für nächsten Aufruf iterieren
         ...
         speechOutput = "Ok, der nächste Artikel. Rot-Rot-Grün: Linken-Spitze sieht in Nahles keine Partnerin für Linksbündnis im Bund. Ob sich die SPD mit Andrea Nahles erneuert? Linksparteichef Riexinger bezweifelt das. Eine Option für ein Linksbündnis sieht er mit ihr nicht. Soll ich den vorlesen oder willst du den nächsten hören?";
     ...
     'search': function () {
         ...
         //Your custom intent handling goes here
         speechOutput = "This is a place holder response for the intent named search. This intent has one slot, which is query. Anything else?";
         this.emit(":ask", speechOutput, speechOutput);
     },
     'ignoreSource': function () {
         speechOutput = 'ignoreSource';
